    ...
    <div id="About" className={`about ${isDark ? 'dark' : ''}`}>
      <div className="about-content">
        ...
        <p className={`about-text text-center ${isDark ? 'dark-text' : ''}`}>
          ...
          avec 3 ans d’expérience en illustration numérique et passionnée par
          les <span className="text-highlight">
            nouvelles technologies.
          </span>{' '}
          J’ai intégré l’école O’clock afin de suivre une formation de
          développeur
