...
export default function Skills() {
  ...
  return (
    <>
      <div id="Skill" className={`skills ${isDark ? 'dark' : ''}`}>
        <h2 className="skills-title text-center fw-bold text-uppercase">
          Mes compétences
        </h2>
      </div>

      <div className={`skill-container ${isDark ? 'dark-text' : ''}`}>
        <p className="skill-subtitle text-center fw-semibold">Frontend</p>
      </div>
      <div className={`skill-wrapper ${isDark ? 'dark' : ''}`}>
      ...
      <div className={`skill-container ${isDark ? 'dark-text' : ''}`}>
        <p className="skill-subtitle text-center fw-semibold">Backend</p>
      </div>
              ...
              >
                <g fill="none">
                  ...
                  <defs>
                    ...
                    >
                      <stop stopColor="#98c94f"></stop>
                      <stop offset={1} stopColor="#adff2f"></stop>
                    </linearGradient>
                    <linearGradient
                      ...
                      gradientUnits="userSpaceOnUse"
                    >
                      <stop stopColor="#adff2f"></stop>
                      <stop offset={0.083} stopColor="#aae255"></stop>
                      <stop offset={1} stopColor="#e7ffc2"></stop>
                    </linearGradient>
                  </defs>
                </g>
              </svg>
                ...
                <g fill="none">
                  ...
                  <defs>
                    <linearGradient
                      ...
                      gradientUnits="userSpaceOnUse"
                    >
                      <stop stopColor="#525257"></stop>
                      <stop offset={1} stopColor="#1d1d1f"></stop>
                    </linearGradient>
                    <linearGradient
                      id="vscodeIconsFileTypeVite1"
                      x1={194.651}
                    ...
                    >
                      ...
                      <stop offset={0.083} stopColor="#85858a"></stop>
                      <stop offset={1} stopColor="#4e4e50"></stop>
                    </linearGradient>
                  </defs>
                </g>
              </svg>
